/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 462db4d6e6a49bce67d5725bc7ef8bb4)
// Runtime types generated with workerd@1.20250906.0 2025-09-03 enable_nodejs_http_modules,enable_nodejs_http_server_modules,experimental,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		EXPRESS_API: KVNamespace;
	}
}
...
interface DurableObjectFacetsStartupOptions {
    $class: DurableObjectClass | LoopbackDurableObjectNamespace | LoopbackColoLocalActorNamespace;
